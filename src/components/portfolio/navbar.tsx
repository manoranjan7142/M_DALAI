    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <span className="text-xl font-bold tracking-tighter text-glow-teal">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 px-3 py-1.5 glass rounded-md border border-white/10 text-xs text-muted-foreground"
          >
      ...
      {isMobileMenuOpen && (
        <motion.div
          ...
          className="md:hidden mt-4 glass rounded-xl overflow-hidden border border-white/10"
        >
